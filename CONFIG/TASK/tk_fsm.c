...
POINTS record_points[12] = 
{
	...
	20,		2000,		0,		100,		2000,		{0},  // A

	3,		2000,		1,		100,		2000,		{0},  // A 如果没有说移动的具体高度那就是平移
	...
	10,		2000,		0,		100,		5000,		{0},//OUT
	
	20,		2000,		0,		100,		2000,		{0},//

	20,   2000,   1,    100,    2000,   {0},//
	
	10,   2000,   0,    100,    2000,   {0},//
...
{   
    if(ABS(L_Y-1500)>100)
        {
            MotorState.V_X=-L_Y+1500;//这里为了能够更加符合
